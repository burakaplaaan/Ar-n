...
class InspirationFirestoreRepository {
  ...
  static const Duration _minIntervalBetweenServerFetches = Duration(hours: 1);
  ...
  ///
  /// [prefs] verilirse 1 saatlik throttle uygulanır: son çekim bir saatten
  ...
  static Future<List<InspirationCardModel>> fetchAllCards({
    ...
    try {
      ...
      if (!snap.exists || snap.data() == null) return out;
      ...
      for (final e in raw) {
        ...
        try {
          ...
          debugPrint('InspirationFirestoreRepository: skip bad item: $e2\n$st2');
        }
      }
    } catch (e, st) {
