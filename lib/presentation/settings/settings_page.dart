...
class _GoogleGMarkPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    p.color = green;
    canvas.drawArc(arcRect, _deg(40), _deg(82), false, p);
    p.color = yellow;
    canvas.drawArc(arcRect, _deg(124), _deg(92), false, p);
    p.color = red;
    canvas.drawArc(arcRect, _deg(216), _deg(98), false, p);
    p.color = blue;
    canvas.drawArc(arcRect, _deg(314), _deg(74), false, p);
    ...
    canvas.drawLine(
      ...
      Offset(center.dx + radius * 1.02, center.dy),
      bar,
    );
  }
